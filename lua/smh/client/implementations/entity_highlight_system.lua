...
function SYS:Init()
    ...
    hook.Add("PostDrawEffects", "SMHEntityHighlight", function()
        if not self.highlight or not IsValid(self.entity) then
            return
        end

        RenderHalo(self.entity)
    end)
end

function SYS:EventSelectEntity(entity)
    self.entity = entity
end
...
SMH.Systems.Register("EntityHighlightSystem", SYS)